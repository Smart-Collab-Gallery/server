...
func (c *userClient) GetLoginUser(ctx context.Context, in *GetLoginUserRequest, opts ...grpc.CallOption) (*GetLoginUserReply, error) {
	...
	err := c.cc.Invoke(ctx, User_GetLoginUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetUserVOById(ctx context.Context, in *GetUserVOByIdRequest, opts ...grpc.CallOption) (*GetUserVOByIdReply, error) {
	...
	err := c.cc.Invoke(ctx, User_GetUserVOById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) ListUserByPage(ctx context.Context, in *ListUserByPageRequest, opts ...grpc.CallOption) (*ListUserByPageReply, error) {
	...
	err := c.cc.Invoke(ctx, User_ListUserByPage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) UpdateMyInfo(ctx context.Context, in *UpdateMyInfoRequest, opts ...grpc.CallOption) (*UpdateMyInfoReply, error) {
	...
	err := c.cc.Invoke(ctx, User_UpdateMyInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) SendEmailVerificationCode(ctx context.Context, in *SendEmailVerificationCodeRequest, opts ...grpc.CallOption) (*SendEmailVerificationCodeReply, error) {
	...
	err := c.cc.Invoke(ctx, User_SendEmailVerificationCode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) VerifyAndUpdateEmail(ctx context.Context, in *VerifyAndUpdateEmailRequest, opts ...grpc.CallOption) (*VerifyAndUpdateEmailReply, error) {
	...
	err := c.cc.Invoke(ctx, User_VerifyAndUpdateEmail_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServer) UpdateMyInfo(context.Context, *UpdateMyInfoRequest) (*UpdateMyInfoReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateMyInfo not implemented")
}
...
func (UnimplementedUserServer) VerifyAndUpdateEmail(context.Context, *VerifyAndUpdateEmailRequest) (*VerifyAndUpdateEmailReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VerifyAndUpdateEmail not implemented")
}
