...
type Cos struct {
	...
	Buckets       map[string]*CosBucket  `protobuf:"bytes,3,rep,name=buckets,proto3" json:"buckets,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // 多存储桶配置（key: image/video/document 等）
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\rwrite_timeout\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"_\n" +
	"\x04Auth\x12\x1d\n" +
	"\n" +
	...
	"\aenabled\x18\x02 \x01(\bR\aenabled\"\xf3\x01\n" +
	"\x03Cos\x12\x1b\n" +
	"\tsecret_id\x18\x01 \x01(\tR\bsecretId\x12\x1d\n" +
	"\n" +
	"secret_key\x18\x02 \x01(\tR\tsecretKey\x126\n" +
	"\abuckets\x18\x03 \x03(\v2\x1c.kratos.api.Cos.BucketsEntryR\abuckets\x12%\n" +
	"\x0edefault_bucket\x18\x04 \x01(\tR\rdefaultBucket\x1aQ\n" +
	"\fBucketsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12+\n" +
	"\x05value\x18\x02 \x01(\v2\x15.kratos.api.CosBucketR\x05value:\x028\x01\"\xad\x01\n" +
	"\tCosBucket\x12\x1f\n" +
